...
Initial G3 implementation published as `5f2eba8`; frontend CI `36103433521` passed. Final Sun-facing camera refinement and its orbital-phase regression check are verified locally; final publication evidence follows. No production merge or backend mutation. **Ready for G4: NO — browser/GPU acceptance remains outstanding.** Do not start G4 without explicit authorization. Preserve the branch: it contains unmerged G2/G3 work.
